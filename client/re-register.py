...
b64curl = base64.b64encode(curl.encode('utf8'))
api_url = 'http://{}:{}/api/client/{}'.format(server_ipaddr, server_port, b64curl.decode('utf8'))
...
rsp = req.put(api_url, headers=header, data=json.dumps(cdata))
# print(rdata)
